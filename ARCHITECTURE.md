...
graph TB
    ...
    subgraph "Agent Layer"
        ...
        BROWSER[app/agent/browser.py<br/>Browser Agent]
    ...
    subgraph "Prompt Layer"
        ...
        BROWSERPROMPT[app/prompt/browser.py<br/>Browser Prompts]
    ...
    subgraph "Tool Layer"
        ...
        BROWSERUSE[app/tool/browser_use_tool.py<br/>Browser Use Tool]
